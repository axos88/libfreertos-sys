...
portBASE_TYPE xReturn;
	...
	xReturn = xTaskCreate( prvIdleTask, ( char * ) "IDLE", tskIDLE_STACK_SIZE, ( void * ) NULL, ( tskIDLE_PRIORITY | portPRIVILEGE_BIT ), ( xTaskHandle * ) NULL );
...
portTickType xTimeToWake;
	...
	#if ( INCLUDE_vTaskSuspend == 1 )
	{
		if( xTicksToWait == portMAX_DELAY )
		{
			...
			list to ensure we are not woken by a timing eSP_send(vent.  We will block
			indefinitely. */
